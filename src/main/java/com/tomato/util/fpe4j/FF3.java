...
import static com.tomato.util.fpe4j.Common.rev;
import static com.tomato.util.fpe4j.Common.revb;
...
/**
 * Implementation of the FF3 method for format-preserving encryption defined in NIST SP 800-38G.
 * <p>
...
public class FF3 {
    ...
    /**
     * The maximum number of symbols permitted in plaintext and ciphertext values.
     */
    ...
    /**
     * The minimum number of symbols permitted in plaintext and ciphertext values.
     */
     ...
     *             If the radix is not in the range [{@value com.tomato.util.fpe4j.Constants#MINRADIX}..
     *             {@value com.tomato.util.fpe4j.Constants#MAXRADIX}].
     */
    ...
    /**
     * NIST SP 800-38G Algorithm 10: FF3.Decrypt(K, T, X) - Decrypt a ciphertext string of numerals and produce a
     ...
     * @throws IllegalArgumentException
     *             If T is not 8 bytes long; the length of X is not within the range [minlen..maxlen]; or any value X[i]
    ...
    public int[] decrypt(SecretKey K, byte[] T, int[] X, int n) throws InvalidKeyException {
        ...
        if (n < minlen || n > maxlen) {
            throw new IllegalArgumentException(
                "The length of X is not within the permitted range of " + minlen + ".." + maxlen + ": " + n);
        }
    ...
    /**
     * NIST SP 800-38G Algorithm 9: FF3.Encrypt(K, T, X) - Encrypt a plaintext string of numerals and produce a
    ...
    /**
     * Returns the maximum length of plaintext and ciphertext inputs based on the radix.
     * 
     * @return The maximum length of plaintext and ciphertext inputs based on the radix.
     */
    ...
    /**
     * Returns the minimum length of plaintext and ciphertext inputs based on the radix.
     * 
     * @return The minimum length of plaintext and ciphertext inputs based on the radix.
     */
