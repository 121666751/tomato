...
public class Functions {
    ...
    /**
     * Vector of bytes containing the two’s compliment representation of an integer.
     * <p>
     * This is a direct implementation in place of the algorithm in the specification. It can be compared to
     * bytesX(BigInteger) to verify it's correctness.
     * <p>
     * Inputs:<br>
     ...
     * Vector of bytes containing the two’s compliment representation of an integer.
     * <p>
     * This is a direct implementation in place of the algorithm in the specification. It can be compared to bytesX(int)
    ...
    /**
     * Prime factors of the integers in a vector. See Appendix A for alternative implementations.
     * <p>
     * Inputs:<br>
     ...
     * 
     * @param W
     *            a vector of integers of arbitrary length, where each integer is greater than or equal to two
     ...
     * <p>
     * This is a direct implementation in place of the algorithm in the specification. It can be compared to
     * integerX(byte[]) to verify it's correctness.
     * <p>
     * Inputs:<br>
     * X, a vector of bytes
     * <p>
    ...
    /**
     * Generate a vector of x elements where the nth element contains a vector of the prime factors of n.
     * <p>
     * Input:<br>
     * x, a constrained integer greater than 1
     * <p>
     * Output:<br>
     * E, a vector of x elements where the nth element contains a vector of the prime factors of n
     * 
     * @param x
     *            the upper limit of the search for primes
     * @return an array of List&lt;Integer&gt; where each List contains the prime factors of the index of the List;
     *         elements 0 and 1 are null
     */
     ...
     * <p>
     * Modified form of the function for use within the search for prime factors. The restriction to integer range is
     * appropriate because we never factor numbers outside this range.
     * <p>
     * Inputs:<br>
    ...
    /**
     * Square root of an unconstrained integer, calculated using the Babylonian method
     * <p>
     * Inputs:<br>
