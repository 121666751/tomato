...
/**
 * FFX parameter set for the A10 algorithm defined in
...
public class A10Parameters implements FFXParameters {
    ...
    final FFX.SplitFunction a10Splitter = new FFX.SplitFunction() {
        ...
        @Override public int split(int n) {
            return floor(n / 2.0);
        }
    };
    ...
    final FFX.RoundCounter a10RoundCounter = new FFX.RoundCounter() {
        ...
        @Override public int rnds(int n) {
            if (n < 4 || n > 36) {
    ...
    final FFX.RoundFunction a10Round = new FFX.RoundFunction() {
        ...
        @Override public int[] F(SecretKey K, int n, byte[] T, int i, int[] B) throws InvalidKeyException {
            ...
            byte[] P =
                {0, 1, 2, 1, (byte)getRadix(), obn[0], obs[0], obr[0], ebt[7], ebt[6], ebt[5], ebt[4], ebt[3], ebt[2],
                    ebt[1], ebt[0]};
        ...
        @Override public boolean validKey(SecretKey K) {
            // validate K
            if (K == null) {
                return false;
            }
    ...
    @Override public int getRadix() {
        return 10;
    }

    @Override public int getMinLen() {
        return 4;
    }

    @Override public int getMaxLen() {
        return 36;
    }

    @Override public int getMinTLen() {
        return 0;
    }

    @Override public int getMaxTLen() {
        return Integer.MAX_VALUE;
    }

    @Override public ArithmeticFunction getArithmeticFunction() {
        return FFX.getBlockwiseArithmeticFunction(getRadix());
    }

    @Override public FeistelMethod getFeistelMethod() {
        return FeistelMethod.TWO;
    }

    @Override public SplitFunction getSplitter() {
        return a10Splitter;
    }

    @Override public RoundCounter getRoundCounter() {
        return a10RoundCounter;
    }

    @Override public RoundFunction getRoundFunction() {
        return a10Round;
    }
}
